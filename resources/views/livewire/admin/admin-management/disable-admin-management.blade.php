        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center p-4" wire:ignore.self>
            ...
            <div class="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-xl dark:shadow-2xl rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ $isCurrentlyDisabled ? 'Enable Account' : 'Disable Account' }}</h3>
                ...
                <div class="flex items-center mb-4">
                    <div class="shrink-0 w-12 h-12 {{ $isCurrentlyDisabled ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30' }} rounded-full flex items-center justify-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            @if($isCurrentlyDisabled)
                                This will allow the admin to access the system again.
                            @else
                                This will prevent the admin from accessing the system. Their data will be preserved.
                            @endif
                        </p>
                    </div>
                </div>
