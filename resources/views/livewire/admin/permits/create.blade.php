    ...
    <form wire:submit.prevent="submitForm" id="step-form" class="space-y-4" novalidate>
        ...
        >
            <div data-step="1" class="space-y-4" @style(["display:none" => $currentStep !== 1])>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Attachments <span class="text-xs font-normal text-gray-400 normal-case">(optional)</span>
                    </label>

                    <label class="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 transition-colors bg-gray-50 dark:bg-gray-900">
                        <svg class="w-6 h-6 text-gray-400 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="text-xs text-gray-500 dark:text-gray-400">Click to upload images</span>
                        ...
                        <div class="flex flex-wrap gap-2 mt-3">
                            @foreach ($photos as $i => $photo)
                                <div class="relative w-20 h-20">
                                    <img src="{{ $photo->temporaryUrl() }}" class="w-20 h-20 object-cover rounded-lg border border-gray-200 dark:border-gray-700" />
